...
import { H4, Ul, Li, Input } from "../../Components/Forms/Forms";
          ...
          <div className="container emp-profile">
            <form method="post">
                ...
                <div className="row">
                    <div className="col-md-4">
                        <div className="profile-img">
                            <img src={userData?.profilePhotoUrl == "" ? 
                              ...
                              : userData?.profilePhotoUrl} alt="user_profile"
                            />
                        </div>
                    </div>
                    <div className="col-md-6">
                        <div className="profile-head">
                            ...
                            <ul className="nav nav-tabs" id="myTab" role="tablist">
                                ...
                                <li className="nav-item">
                                    <a className="nav-link" id="ride-tab" data-toggle="tab" href="#ride" role="tab" aria-controls="profile" aria-selected="false">Ride</a>
                                </li>
                                <li className="nav-item">
                                    <a className="nav-link" id="credit-tab" data-toggle="tab" href="#credit" role="tab" aria-controls="profile" aria-selected="false">Credit</a>
                                </li>
                            </ul>
                        </div>
                    </div>
                                ...
                                <div className="tab-pane fade show active" id="home" role="tabpanel" aria-labelledby="home-tab">
                                    <div className="row">
                                        ...
                                        {aboutColsAnswer.map((col, index) => (
                                          <p key={index}>
                                            <Input
                                              value={userData[col] !== null ? col : ""}
                                              onChange={(event) => onChange(event, col)}
                                              disabled={!isEditing}
                                              style={{marginLeft: -25}}
                                            />
                                          </p>
                                ...
                                <div className="tab-pane fade" id="ride" role="tabpanel" aria-labelledby="profile-tab">
                                    <div className="row">
                                        ...
                                        <div style={{marginLeft: '25%'}}>
                                          <li className='page_num'><a onClick={() => preRidePage()}><b>이전</b></a></li>
                                          <li className='page_num'>{ridepage}</li>
                                          <li className='page_num'><a onClick={() => postRidePage()}><b>다음</b></a></li>
                                        </div>
                                    </div>
                                    {/* <div className="row">
                                ...
                                <div className="tab-pane fade" id="credit" role="tabpanel" aria-labelledby="profile-tab">
                                    <div className="row">
                                      <div className="col-md-6">
                                        ...
                                        <div style={{marginLeft: '25%'}}>
                                          <li className='page_num'><a onClick={() => preCreditPage()}><b>이전</b></a></li>
                                          <li className='page_num'>{creditpage}</li>
                                          <li className='page_num'><a onClick={() => postCreditPage()}><b>다음</b></a></li>
                                        </div>
                                    </div>
                                    {/* <div className="row">
                                        <div className="col-md-12">
                    ...
                    <Button variant="success" style={editBtn} onClick={() => goBack(history)}>뒤로가기</Button>
                    <Button variant="secondary" style={isEditing === false? editBtn : nonEditBtn} onClick={editUser}>수정</Button>
                    <Button variant="secondary" style={isEditing === true? editBtn : nonEditBtn} onClick={confirmEdit}>확인</Button>
                    <Button variant="danger" style={editBtn} onClick={deleteUser}>삭제</Button>
                </form>
            </div>
        //   <Wrapper>
        //     <H4>기본 정보</H4>
