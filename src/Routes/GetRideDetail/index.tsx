              ...
              <div className="row">
                <div className="col-md-4">
                  <div className="profile-img">
                    <img
                      src={data?.GetRideDetail.ride.passenger?.profilePhotoUrl}
                      alt="drivier_profile"
                    />
                  </div>
                </div>
                <div className="col-md-6">
                  <div className="profile-head">
                    <h5>
                      {data?.GetRideDetail.ride.driver?.fullName} (
                      {data?.GetRideDetail.ride.driver?.id})
                    </h5>
                    <h6>{data?.GetRideDetail.ride.driver?.phoneNumber}</h6>
